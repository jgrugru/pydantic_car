from pydantic import Field, BaseModel, confloat, StrictFloat, validator, condecimal
...
class Percent(float):
    ...
    def validate(cls, v):
        ...
        if not 0 <= v <= 1:
            raise TypeError('Not a valid percent. Needs to be within 0.0 <= value <= 1.00')
        return v
